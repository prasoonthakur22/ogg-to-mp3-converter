...
<footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
    ...
    <div>
        <p>Copyright &copy;2022 <a class="text-black-500 font-bold link link-hover" href="#"></a> {{ config('app.name') }} | Developed by <a class="text-black-500 font-bold link link-hover hover:text-white" href="https://anuragdeep.com">Anurag Deep</a></p>
    </div>
</footer>
<!-- /footer -->