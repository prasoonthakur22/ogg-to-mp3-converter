    ...
    <div class="flex flex-wrap mt-16 md:mt-0 lg:mt-0 p-[0rem] md:p-[5rem] lg:p-[5rem]">
        ...
        <div class="w-full min-h-[80vh] flx flex-col  rounded-3xl ">
            <div class="card p-5 md:p-10 rounded-3xl drop-shadow-xl overflow-hidden flex-1 flex flex-col items-center">
                ...
                <!-- FileInfo  -->
                <div id="fileInfoBox" class="bg-[#346CFB] flow-root hide mt-5 mb-5 w-full sm:w-full md:w-1/1 lg:w-1/2 m-5 card p-10 rounded-lg drop-shadow-3xl overflow-hidden items-center ">
                ...
                <!-- Form  -->
                <form id="audioUploadForm" method="POST" enctype="multipart/form-data" class="m-5 items-center w-full sm:w-full md:w-1/1 lg:w-1/2">
                    <div id="uploadArea">
                ...
                <!-- Message  -->
                <div id="messageBox" class="alert alert-warning shadow-lg m-5 w-full sm:w-full md:w-1/1 lg:w-1/2 hide">
                    <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/Users/AnuragDeep/OneDrive/Desktop/Freelancing/ogg-to-mp3-converter/resources/views/home.blade.php ENDPATH**/ ?>