...
<header>
    <nav style="height: 50px;" class="fixed mx-auto top-0 left-0 right-0 z-[500] shadow-xl flex bg-[#005DFA] 2xl:px-[11%] xl:px-[11%] lg:px-[11%] md:px-[10rem] sm:px-10 px-5 ">
        ...
        <div class="">
            <div class="">
                <a href="/"><img src="<?php echo e(URL::asset('images/logo.png')); ?>" class="w-12 md:w-12 lg:w-12 p-1 mt-1 md:mt-1 lg:mt-1 inline" alt="<?php echo e(config('app.name')); ?>" />
...
<!-- Header end  -->
<?php /**PATH /mnt/c/Users/AnuragDeep/OneDrive/Desktop/Freelancing/ogg-to-mp3-converter/resources/views/components/header.blade.php ENDPATH**/ ?>